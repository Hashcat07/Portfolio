...
// Hover-to-decode kinetic type: characters scramble then resolve left→right,
// with an animated underline and a soft accent glow. primary = crimson here.
// Spaces are rendered as a non-breaking space so the per-char inline-block
// spans don't collapse them (that turned "VIEW WORK" into "VIEWWORK").
export function TextScramble({ text, className = '' }: TextScrambleProps) {
  ...
  return (
    ...
    >
      <span className="relative font-mono text-lg tracking-widest uppercase whitespace-pre">
